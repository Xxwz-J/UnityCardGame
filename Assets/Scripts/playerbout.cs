...
public class playerbout : MonoBehaviour
{
    ...
    private Vector2 positionInit1 = new Vector2(590, 145);
    private Vector2 positionInit2 = new Vector2(825, 145);
    private Vector2[] position = new Vector2[4];
    private Vector2 size = new Vector2(105, 130);
    ...
    void Start()
    {
        ...
        selected = true;
        index = 0;
        position[0] = new Vector2(-420, 190);
        position[1] = new Vector2(-180, 190);
        position[2] = new Vector2(60, 190);
        position[3] = new Vector2(300, 190);
    ...
    private void GetInitCards1()
    {
        ...
        CardsMove();
        MonsterCard newone1 = new MonsterCard((MonsterCard)allCards.cards[2]);
    ...
    public void CardsMove()
    {
        ...
        float setx = 180 - 135 * num;
        for(int i=0;i<num;i++)
        {
            Vector3 position = new Vector3(setx, -200, 0);
