...
public class gamecontroller : MonoBehaviour
{
    ...
    private Vector3 v2 = new Vector3(0, -165, -100);//相机位置2
    ...
    private Vector2 size = new Vector2(210, 260);
    ...
    void Start()
    {
        ...
        gameOver = false;
        positionpla[0] = new Vector2(-210, 95);
        positionpla[1] = new Vector2(-90, 95);
        positionpla[2] = new Vector2(30, 95);
        positionpla[3] = new Vector2(150, 95);
        firstv[0] = new Vector2(-210, -62);
        firstv[1] = new Vector2(-90, -62);
        firstv[2] = new Vector2(30, -62);
        firstv[3] = new Vector2(150, -62);
        secondv[0] = new Vector2(-210, 90);
        secondv[1] = new Vector2(-90, 90);
        secondv[2] = new Vector2(30, 90);
        secondv[3] = new Vector2(150, 90);
        if (isboss)
        {
            if(life==2)
            {
    ...
    private void Buildcard(int line,MonsterCard card,int id)
    {
        if (card != null)
        {
            ...
            if (line == 1)
                rectTransform.anchoredPosition = firstv[id]*2;
            else if (line == 2) rectTransform.anchoredPosition = secondv[id]*2;
    ...
    private void AttackEvent()
    {
        ...
        if (!begin)
        {
            if (playercards[ind] != null)
            {
                ...
                {
                    Attack a = showedpla[ind].GetComponent<Attack>();
                    //a.startPosition = positionpla[ind];
                    a.enabled = true;
                    enabled = false;
                }
            }
        ...
        else
        {
            if (firstlinecards[ind] != null)
            {
                ...
                {
                    Attack a=firshowed[ind].GetComponent<Attack>();
                    //a.startPosition = firstv[ind];
                    a.enabled = true;
                    enabled = false;
                }
            }
